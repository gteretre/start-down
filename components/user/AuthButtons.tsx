...
import { Unplug, LogInIcon } from 'lucide-react';
...
export function SignInButtons() {
  return (
    <>
      ...
      <div className="nav-element md:hidden">
        <Link href="/auth/signin" className="btn-pure inline-flex items-center">
          <Tooltip text="Sign In" position="left">
            <LogInIcon size={24} />
          </Tooltip>
        </Link>
      </div>
